                ...
                <div class="w-screen max-w-md">
                    <form class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
                            ...
                            <div class="py-6 px-4 bg-indigo-700 sm:px-6">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="ml-3 h-7 flex items-center">
                                        <button v-on:click="$emit('cancel-add-file')" type="button" class="bg-indigo-700 rounded-md text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <div class="mt-1">
                                    <p class="text-sm text-indigo-300">
                                        Upload a file by completing this form
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                    <div class="space-y-6 pt-6 pb-5">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <textarea v-model="record.description" id="description" name="description" rows="4" class="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md"></textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mt-2 space-y-5">
                                                <div class="relative flex items-start">
                                                    <div class="absolute flex items-center h-5">
                                                        <input value="0" v-model="record.document_permission" id="privacy_private" name="privacy" aria-describedby="privacy_private_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" checked>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="relative flex items-start">
                                                        <div class="absolute flex items-center h-5">
                                                            <input value="1" v-model="record.document_permission" id="privacy_protected" name="privacy" aria-describedby="privacy_protected_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                        </div>
                                                        <div class="pl-7 text-sm">
                                                    ...
                                                    <div v-if="record.document_permission === '1'" class="mt-2 py-4">
                                                        ...
                                                        <div class="mt-1">
                                                            <input v-model="record.password" type="text" name="password" id="password" class="block w-full shadow-sm sm:text-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    <div class="relative flex items-start">
                                                        <div class="absolute flex items-center h-5">
                                                            <input value="2" v-model="record.document_permission" id="privacy_public" name="privacy" aria-describedby="privacy_public_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                        </div>
                                                        <div class="pl-7 text-sm">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="mt-2 space-y-5">
                                                ...
                                                <div>
                                                    <div class="relative flex items-start">
                                                        <div class="absolute flex items-center h-5">
                                                            <input value="1" v-model="record.is_featured" id="is_featured" name="featured" aria-describedby="is_featured_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                        </div>
                                                        <div class="pl-7 text-sm">
                                                ...
                                                <div>
                                                    <div class="relative flex items-start">
                                                        <div class="absolute flex items-center h-5">
                                                            <input value="0" v-model="record.is_featured" id="is_featured_no" name="featured" aria-describedby="is_featured_no_description" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                        </div>
                                                        <div class="pl-7 text-sm">
                        ...
                        <div class="flex-shrink-0 px-4 py-4 flex justify-end">
                            <button type="button" @click="$emit('cancel-add-file')" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancel
                            </button>
                            <button @click="addDocument()" type="button" class="ml-4 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Save
                            </button>
                        </div>
                    </form>
