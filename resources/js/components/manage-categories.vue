                    ...
                    <div class="w-screen max-w-md">
                        <form class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
                                    ...
                                    <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                        <div class="space-y-6 pt-6 pb-5">
                                            <div>
                                                ...
                                                <add-document-category v-if="show.add" @cancel-add-category="show.add = false" @added-category="categoryUpdated(); show.add = false;"></add-document-category>
                                                        ...
                                                        <div class="rounded bg-gray-200 p-6">
                                                            <div class="flex justify-between">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <button type="button" @click="deleteCategory(category.id)" :disabled="category.documents.length > 0">
                                                                        <svg class="w-6 h-6 " :class="{'text-gray-400':category.documents.length > 0,'text-gray-700':category.documents.length === 0}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex-shrink-0 px-4 py-4 flex justify-end">
                                <button v-on:click="$emit('cancel-manage-categories')" type="button"
...
export default {
    ...
    emits: ['cancel-manage-categories', 'categories-updated'],
