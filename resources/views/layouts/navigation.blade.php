<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:border-gray-900  dark:bg-gray-800">
...
{{--                    <x-nav-link :href="route('user-directory.index')" :active="request()->routeIs('user-directory.index')">{{ __('User Directory') }}</x-nav-link>--}}
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('user-directory.index')" :active="request()->routeIs('user-directory.index')">{{ __('User Directory') }}</x-responsive-nav-link>
        </div>
